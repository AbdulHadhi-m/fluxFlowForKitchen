    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {isLoading ? (
          ...
          <div className="col-span-full p-16 text-center text-slate-500 text-sm bg-slate-100/70 dark:bg-slate-900/40 rounded-2xl border border-slate-200 dark:border-slate-800">
          ...
          suppliers.map((s) => (
            <div
              key={s.id}
              className="p-5 rounded-2xl bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 backdrop-blur-md space-y-4 hover:border-slate-300 dark:hover:border-slate-700/80 transition-all flex flex-col justify-between"
            >
                ...
                <div className="space-y-1.5 text-xs text-slate-500 dark:text-slate-400 pt-1">
                  {s.contact_person && (
                    <p className="flex items-center gap-2">
                      ...
                      <strong className="text-slate-600 dark:text-slate-300">{s.contact_person}</strong>
                    </p>
                  )}
                  {s.phone && (
              ...
              <div className="flex items-center gap-2 pt-3 border-t border-slate-200 dark:border-slate-800">
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-1.5 py-1.5 px-3 rounded-lg text-xs font-semibold bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-200 hover:bg-slate-300 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white transition-colors"
                >
