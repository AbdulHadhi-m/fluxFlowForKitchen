...
export const ProcurementBudgetsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Budgets Grid */}
      {isLoading ? (
        <div className="py-16 text-center text-slate-400 text-sm">Loading procurement budgets...</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {budgets.map((b) => {
            ...
            return (
              <div
                key={b.id}
                className="p-6 rounded-2xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-md space-y-4 shadow-xl"
              >
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="font-mono font-bold text-white">
                      ${b.committed_amount} / <span className="text-slate-400">${b.allocated_amount}</span>
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between text-[11px]">
                    ...
                    <span className={`font-bold font-mono ${isWarning ? "text-rose-400" : "text-slate-300"}`}>
                      {pct.toFixed(1)}%
                    </span>
                  </div>
                </div>
                ...
                <div className="pt-3 border-t border-slate-800/80 flex items-center justify-between text-xs text-slate-500">
                  ...
                  <span className="font-semibold text-slate-400 uppercase text-[10px]">{b.period_type}</span>
                </div>
              </div>
            );
          })}
