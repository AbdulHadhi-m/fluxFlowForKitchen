        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-3.5 pt-1">
          <div className="space-y-1">
            <div className="flex justify-between items-center">
              <label className="text-xs text-slate-300">Adjustment Delta Quantity (+ or -)</label>
              <span className="text-[11px] text-slate-400 font-mono">Use '-' to reduce</span>
            </div>
            <Input
              type="number"
              step="0.001"
          ...
          <div className="space-y-1">
            <label className="text-xs text-slate-300">Adjustment Reason</label>
            <Input
              {...register("reason")}
