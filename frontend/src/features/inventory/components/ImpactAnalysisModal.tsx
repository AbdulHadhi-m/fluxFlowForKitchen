          ...
          <div className="flex items-center gap-3">
            <div className="flex-1">
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-lg bg-slate-950 border border-slate-800 text-slate-100 text-sm font-mono focus:border-amber-500"
              />
            </div>
            <button
              type="button"
          ...
          {analysis && (
            <div className="space-y-4">
              <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 flex items-center justify-between">
                <span className="text-xs text-slate-400">Impacted Menu Dishes</span>
              ...
              <div className="space-y-2">
                {analysis.impacted_items?.map((item: any) => (
                  <div
                    key={item.recipe_id}
                    className="p-3.5 rounded-xl bg-slate-950/40 border border-slate-800 flex items-center justify-between text-xs"
                  >
                    <div>
                    ...
                    <div className="text-right">
                      <div className="flex items-center gap-1.5 justify-end font-mono">
                        <span className="text-slate-400">${item.old_recipe_cost}</span>
