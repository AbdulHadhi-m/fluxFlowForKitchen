      ...
      <div className="max-w-7xl mx-auto w-full space-y-4">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            <Link to="/dashboard">
              <Button
                variant="outline"
                size="sm"
                className="h-8 w-8 p-0 border-slate-800 hover:bg-slate-900 text-slate-300"
              >
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-base font-bold text-white">POS Terminal</h1>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between sm:justify-end gap-3 w-full sm:w-auto">
            ...
            <Link to="/orders/history">
              <Button
                variant="outline"
                size="sm"
                className="border-slate-800 hover:bg-slate-900 text-xs text-slate-300 gap-1.5 h-8"
              >
        ...
        <div className="relative w-full max-w-sm">
          ...
          <Input
            ...
            className="pl-8 bg-slate-900/60 border-slate-800 text-xs h-8"
          />
        </div>
