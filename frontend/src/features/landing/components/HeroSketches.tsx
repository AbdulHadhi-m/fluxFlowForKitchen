...
export const LeftHeroIllustration: React.FC<{ className?: string }> = ({ className = "" }) => {
  return (
    ...
    >
      {/* Hand-Drawn Bakery & Cafe Shopfront with Purple Tints */}
      <g stroke="#7C3AED" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        {/* Soft Lavender Tint Fills */}
        <path
        ...
        <path d="M35 105 L45 125 L55 105" fill="#DDD6FE" fillOpacity="0.8" />
        <path d="M75 105 L85 125 L95 105" fill="#C4B5FD" fillOpacity="0.8" />
        <path d="M115 105 L125 125 L135 105" fill="#DDD6FE" fillOpacity="0.8" />
        <path d="M155 105 L165 125 L175 105" fill="#C4B5FD" fillOpacity="0.8" />
        <path d="M195 105 L205 125 L215 105" fill="#DDD6FE" fillOpacity="0.8" />
        ...
        {/* Left Shop Door */}
        <rect x="35" y="115" width="45" height="150" rx="3" fill="#F5F3FF" fillOpacity="0.6" />
        <rect x="42" y="125" width="31" height="45" rx="2" strokeDasharray="3 2" />
        <circle cx="72" cy="195" r="3" fill="#7C3AED" />
        ...
        <path d="M105 155 C105 145, 118 145, 122 155 Z" fill="#DDD6FE" />
        <path d="M130 155 C130 145, 143 145, 147 155 Z" fill="#DDD6FE" />
        <path d="M155 155 C155 145, 168 145, 172 155 Z" fill="#DDD6FE" />
        <path d="M180 155 C180 145, 193 145, 197 155 Z" fill="#DDD6FE" />
        <path d="M203 155 C203 145, 215 145, 218 155 Z" fill="#DDD6FE" />

        {/* Middle Shelf Bread Loaves & Cakes */}
        <ellipse cx="115" cy="185" rx="10" ry="6" fill="#C4B5FD" />
        <ellipse cx="140" cy="185" rx="10" ry="6" fill="#C4B5FD" />
        <ellipse cx="165" cy="185" rx="10" ry="6" fill="#C4B5FD" />
        <ellipse cx="190" cy="185" rx="10" ry="6" fill="#C4B5FD" />
        ...
        <path d="M245 220 L250 255 L280 255 L285 220 Z" fill="#EDE9FE" />
        {/* Bush Foliage */}
        <circle cx="255" cy="205" r="14" fill="#DDD6FE" fillOpacity="0.8" />
        <circle cx="275" cy="200" r="16" fill="#C4B5FD" fillOpacity="0.8" />
        <circle cx="265" cy="185" r="15" fill="#DDD6FE" fillOpacity="0.8" />
        <circle cx="250" cy="190" r="10" fill="#EDE9FE" fillOpacity="0.8" />
...
export const RightHeroIllustration: React.FC<{ className?: string }> = ({ className = "" }) => {
  return (
    <svg
      ...
      className={`select-none pointer-events-none ${className}`}
    >
      {/* Hand-Drawn European Cafe Patio Scene with Parasol & Bistro Table */}
      <g stroke="#7C3AED" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        {/* Background Bistro Building Facade & Canopy */}
        <path d="M80 30 L290 30 L310 75 L100 75 Z" fill="#EDE9FE" fillOpacity="0.6" />
        ...
        {/* Large Parasol Patio Umbrella with Pastel Pinkish-Lavender Fill */}
        <path
        ...
        <ellipse cx="90" cy="190" rx="42" ry="12" fill="#EDE9FE" />
        
        {/* Table Leg & Cast Iron Base */}
        <line x1="90" y1="202" x2="90" y2="245" strokeWidth="2" />
        <ellipse cx="90" cy="245" rx="18" ry="4" fill="#C4B5FD" />

        {/* Tabletop Wine Bottle & Glasses */}
        <path d="M85 186 L85 174 L88 174 L88 170 L92 170 L92 174 L95 174 L95 186 Z" strokeWidth="1" fill="#DDD6FE" />
        <path d="M72 184 L76 176 L80 184 Z" strokeWidth="0.9" />
        <line x1="76" y1="184" x2="76" y2="188" strokeWidth="0.9" />

        {/* Left Bistro Chair with Lavender Cushions */}
        <path d="M35 185 C35 168, 55 168, 55 185 L55 225 L35 255" strokeWidth="1.3" fill="#EDE9FE" fillOpacity="0.7" />
        <ellipse cx="45" cy="210" rx="12" ry="5" fill="#C4B5FD" />
        <line x1="38" y1="213" x2="33" y2="255" strokeWidth="1.2" />
        <line x1="52" y1="213" x2="57" y2="255" strokeWidth="1.2" />

        {/* Right Bistro Chair with Lavender Cushions */}
        <path d="M125 185 C125 168, 145 168, 145 185 L145 225 L125 255" strokeWidth="1.3" fill="#EDE9FE" fillOpacity="0.7" />
        <ellipse cx="135" cy="210" rx="12" ry="5" fill="#C4B5FD" />
        ...
        <rect x="215" y="165" width="20" height="30" rx="2" fill="#DDD6FE" strokeWidth="1.2" />
