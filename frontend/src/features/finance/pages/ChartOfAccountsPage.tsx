      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2.5">
            ...
            <h1 className="text-2xl font-black tracking-tight text-slate-900 dark:text-white">Chart of Accounts (COA)</h1>
          </div>
        ...
        <div className="flex items-center gap-3">
          {accounts.length === 0 && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold text-emerald-600 dark:text-emerald-300 bg-emerald-500/10 border border-emerald-500/30 hover:bg-emerald-500/20 transition-colors"
            >
          ...
          <tbody className="divide-y divide-slate-200 dark:divide-slate-800/60">
            {isLoading ? (
              ...
              filteredAccounts.map((acc) => (
                <tr key={acc.id} className="hover:bg-slate-100/70 dark:hover:bg-slate-900/40 transition-colors">
                  <td className="p-4 font-mono font-bold text-slate-900 dark:text-white text-sm">{acc.code}</td>
                  ...
                  <td className="p-4 text-slate-500 dark:text-slate-400 truncate max-w-xs">{acc.description || "—"}</td>
