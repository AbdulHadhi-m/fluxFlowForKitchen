        ...
        <div className="flex flex-wrap gap-3 items-center">
          <div className="w-64">
            <select
              ...
              className="w-full bg-white dark:bg-slate-950 border-slate-200 dark:border-slate-800 rounded-xl px-3 py-2 text-xs text-slate-900 dark:text-white focus:outline-none focus:border-emerald-500"
            >
          ...
          <div className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400">
            ...
            <input
              ...
              className="bg-white dark:bg-slate-950 border-slate-200 dark:border-slate-800 rounded-xl px-3 py-1.5 text-xs text-slate-900 dark:text-white focus:outline-none focus:border-emerald-500"
            />
          </div>
            ...
            {isLoading ? (
              ...
              ledger.lines.map((l) => (
                <tr key={l.id} className="hover:bg-slate-100/70 dark:hover:bg-slate-900/40 transition-colors">
                  ...
                  <td className="p-4 font-mono font-bold text-emerald-400">{l.entry_number}</td>
