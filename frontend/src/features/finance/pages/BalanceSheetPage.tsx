      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2.5">
            ...
            <h1 className="text-2xl font-black tracking-tight text-white">Balance Sheet (Financial Position)</h1>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
        ...
        <div className="rounded-2xl border border-slate-800 bg-slate-900/60 backdrop-blur-md p-6 space-y-4">
          <div className="border-b border-slate-800 pb-3 flex justify-between items-center">
            <h2 className="text-sm font-bold text-white uppercase tracking-wider">Total Assets</h2>
          ...
          <div className="space-y-3 text-xs pl-2">
            <div className="flex justify-between py-1 text-slate-300">
              ...
              <span className="font-mono text-white font-medium">Included</span>
            </div>
            <div className="flex justify-between py-1 text-slate-300">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/60 backdrop-blur-md p-6 space-y-4">
            <div className="border-b border-slate-800 pb-3 flex justify-between items-center">
              <h2 className="text-sm font-bold text-white uppercase tracking-wider">Total Liabilities</h2>
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/60 backdrop-blur-md p-6 space-y-4">
            <div className="border-b border-slate-800 pb-3 flex justify-between items-center">
              <h2 className="text-sm font-bold text-white uppercase tracking-wider">Owner's Equity</h2>
            ...
            <div className="space-y-2 text-xs pl-2">
              <div className="flex justify-between py-1 text-slate-300">
                ...
                <span className="font-mono text-white font-medium">${capital.toFixed(2)}</span>
              </div>
              <div className="flex justify-between py-1 text-slate-300">
