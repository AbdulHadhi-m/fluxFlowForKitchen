...
export const CashFlowStatementPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="max-w-3xl mx-auto rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 backdrop-blur-md p-8 space-y-6">
        <div className="border-b border-slate-200 dark:border-slate-800 pb-3 flex justify-between items-center">
          <h2 className="text-sm font-bold text-slate-900 dark:text-white uppercase tracking-wider">Operating Activities</h2>
        ...
        <div className="flex justify-between p-4 rounded-xl bg-white dark:bg-slate-950 border-slate-200 dark:border-slate-800 text-sm font-bold">
          <span className="text-slate-900 dark:text-white">Net Cash Movement in Period</span>
