    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-slate-400">Execution KPIs, failure hotspots, and adoption over time</p>
        </div>
        <select
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80">
          <h3 className="text-xs font-bold text-white uppercase tracking-wider mb-4">Executions Per Day</h3>
        ...
        <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80">
          <h3 className="text-xs font-bold text-white uppercase tracking-wider mb-4">Most Used Workflows</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80">
          <h3 className="text-xs font-bold text-white uppercase tracking-wider mb-4">Action Failures</h3>
          {(analytics?.action_failures || []).length === 0 ? (
            ...
            <div className="space-y-3">
              {(analytics?.action_failures || []).map((f) => (
                <div key={f.step_code}>
                  <div className="flex justify-between text-[11px] mb-1">
                    <span className="text-slate-300 font-mono">{f.step_code}</span>
        ...
        <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80 space-y-3">
          <h3 className="text-xs font-bold text-white uppercase tracking-wider">Status Breakdown</h3>
          {[
