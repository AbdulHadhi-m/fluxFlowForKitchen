            ...
            <tbody className="divide-y divide-slate-800/60">
              {accounts.map((acc) => (
                <tr key={acc.id} className="hover:bg-slate-800/40 transition-colors">
                  ...
                  <td className="px-4 py-3 text-right font-black text-indigo-300 text-sm">
                  ...
                  <td className="px-4 py-3 text-right">
                    <Button
                      ...
                      className="h-7 px-2 text-[10px] bg-slate-900 border-slate-800 hover:bg-slate-800 text-slate-300 gap-1"
                    >
