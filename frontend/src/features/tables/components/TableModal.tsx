      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-md shadow-2xl overflow-hidden text-slate-100">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4 text-xs">
          ...
          <div className="space-y-1.5">
            <label className="text-slate-300 font-medium">Table Number / Label *</label>
            <Input
              placeholder="e.g. T01, Table 12, VIP-1"
              {...register("name")}
              className="bg-slate-950/60 border-slate-800 text-slate-100 text-xs font-mono"
            />
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              <label className="text-slate-300 font-medium">Seating Capacity (Seats) *</label>
              <Input
                type="number"
                min={1}
            ...
            <div className="space-y-1.5">
              <label className="text-slate-300 font-medium">Floor Section</label>
              <Input
          ...
          <div className="grid grid-cols-2 gap-3 pt-1">
            <div className="space-y-1.5">
              <label className="text-slate-300 font-medium">Display Rank Order</label>
              <Input
                type="number"
