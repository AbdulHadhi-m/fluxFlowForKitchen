    ...
    >
      ...
      <div className="pt-2 border-t border-slate-200 dark:border-slate-800/80 flex items-center justify-between gap-2">
        <button
          ...
          className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-medium border ${statusInfo.bg} ${statusInfo.text} ${statusInfo.border} hover:brightness-110 transition-all`}
