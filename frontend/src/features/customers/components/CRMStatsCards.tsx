...
import { Users, Repeat, IndianRupee, Award } from "lucide-react";
      ...
      <Card className="bg-white dark:bg-slate-900/60 border-slate-200 dark:border-slate-800">
        <CardContent className="p-4 flex items-center justify-between">
          <div>
            ...
            <div className="text-xl font-black text-emerald-600 dark:text-emerald-300 mt-1">₹{analytics?.total_spend ?? "0.00"}</div>
          </div>
          <div className="h-9 w-9 rounded-xl bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center text-emerald-400">
