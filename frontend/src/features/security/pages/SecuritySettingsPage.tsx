  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto animate-in fade-in duration-300">
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          <h1 className="text-xl font-black tracking-tight text-slate-900 dark:text-white">Tenant Security & Policy Settings</h1>
        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <Card className="bg-white dark:bg-slate-900/60 border-slate-200 dark:border-slate-800 p-5 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              <div>
                <label className="text-slate-600 dark:text-slate-300 font-medium block mb-1">Minimum Length</label>
                <Input
                  type="number"
                  min={8}
                  max={64}
                  ...
                  className="bg-white dark:bg-slate-950 border-slate-200 dark:border-slate-800 text-xs h-9"
                />
              </div>
          ...
          <Card className="bg-white dark:bg-slate-900/60 border-slate-200 dark:border-slate-800 p-5 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              <div>
                <label className="text-slate-600 dark:text-slate-300 font-medium block mb-1">Session Inactivity Timeout (Minutes)</label>
                <Input
                  type="number"
                  min={15}
                  max={1440}
              ...
              <div>
                <label className="text-slate-600 dark:text-slate-300 font-medium block mb-1">Max Concurrent Sessions Per User</label>
                <Input
                  type="number"
                  min={1}
                  max={20}
              ...
              <div>
                <label className="text-slate-600 dark:text-slate-300 font-medium block mb-1">Max Failed Logins Before Lockout</label>
                <Input
                  type="number"
                  min={3}
                  max={10}
              ...
              <div>
                <label className="text-slate-600 dark:text-slate-300 font-medium block mb-1">Lockout Duration (Minutes)</label>
                <Input
                  type="number"
                  min={5}
                  max={120}
