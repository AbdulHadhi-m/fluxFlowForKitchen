      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 w-full max-w-lg shadow-2xl relative">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Configure delivery radius and fee rules</p>
          </div>
        </div>

        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            <label className="text-xs font-semibold text-slate-400">Zone Name</label>
            <input
              {...register('name')}
              placeholder="e.g. Downtown Core / Zone A"
              className="mt-1 w-full px-3.5 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-sm text-white focus:outline-none focus:border-amber-500"
            />
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-xs font-semibold text-slate-400">Delivery Fee ($)</label>
              <input
                {...register('fee')}
                className="mt-1 w-full px-3.5 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-sm text-white focus:outline-none focus:border-amber-500"
              />
            ...
            <div>
              <label className="text-xs font-semibold text-slate-400">Min. Order ($)</label>
              <input
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-xs font-semibold text-slate-400">Transit Duration (mins)</label>
              <input
                type="number"
            ...
            <div>
              <label className="text-xs font-semibold text-slate-400">Priority (1-100)</label>
              <input
                type="number"
                {...register('priority')}
                className="mt-1 w-full px-3.5 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-sm text-white focus:outline-none focus:border-amber-500"
