      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl w-full max-w-lg overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              maxLength={300}
              className="mt-2 w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-xl text-sm text-white placeholder-slate-500 focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 resize-none"
            />
          </div>
          ...
          <div className="flex items-center justify-between pt-2">
            ...
            <div className="flex items-center gap-3 bg-slate-950 border border-slate-800 px-3 py-1.5 rounded-xl">
              ...
              <span className="font-extrabold text-base text-white w-6 text-center">{quantity}</span>
              <button
                type="button"
        ...
        <div className="p-6 bg-slate-950/80 border-t border-slate-800 flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xl font-black text-white">${lineTotal}</p>
          </div>
          <button
            onClick={handleAdd}
