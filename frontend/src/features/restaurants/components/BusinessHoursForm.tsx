        ...
        <form onSubmit={handleSave} className="space-y-4">
          ...
          <div className="divide-y divide-slate-800/80">
            {hours.map((hour, idx) => (
              ...
              >
                <div className="w-28 font-medium text-slate-200">
                    ...
                    <>
                      <div className="flex items-center gap-1.5">
                        ...
                        <Input
                          ...
                          className="h-8 w-28 bg-slate-950/60 border-slate-800 text-slate-100 text-xs"
                        />
                      </div>
                      ...
                      <label className="flex items-center gap-1.5 cursor-pointer text-slate-400" title="Shift extends past midnight into next morning">
                        <input
                          type="checkbox"
